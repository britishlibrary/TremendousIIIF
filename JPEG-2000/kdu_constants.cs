...
namespace kdu_mni
{
    public class Ckdu_global : Ckdu_global_funcs
    {
        ...
        public const int KDU_SAMPLE_ALLOCATOR_MIN_FRAG_BITS = unchecked((int)18);
        public const int KDU_SAMPLE_ALLOCATOR_MAX_FRAG_BITS = unchecked((int)28);
        public const int KDU_SAMPLE_ALLOCATOR_DEF_FRAG_BITS = unchecked((int)26);
        public const byte KDU_LINE_BUF_ABSOLUTE = unchecked((byte)0x01);
        public const byte KDU_LINE_BUF_SHORTS = unchecked((byte)0x02);
        public const byte KDU_LINE_BUF_EXCHANGEABLE = unchecked((byte)0x04);
        public const int KDU_LINE_WILL_BE_EXTENDED = unchecked((int)0x00000001);
        public const int KDU_LINE_EXTRA_WIDTH_MASK = unchecked((int)0x00FFFF00);
        public const int KDU_LINE_EXTRA_WIDTH_POS = unchecked((int)8);
        public const int KDU_LINE_EXTRA_WIDTH_MAX = unchecked((int)65535);
        ...
        public const int KDU_BLOCK_CODER_CAP_J2K1 = unchecked((int)0x001);
        public const int KDU_BLOCK_CODER_CAP_J2K1_SPK64 = unchecked((int)0x010);
        public const int KDU_BLOCK_CODER_CAP_HT = unchecked((int)0x100);
        public const int KDU_BLOCK_CODER_CAP_HTOPT = unchecked((int)0x200);
        public const string KDU_CORE_VERSION = unchecked((string)"v8.3");
        ...
        public const int KDU_PRF = unchecked((int)0xFF56);
        public const int KDU_CPF = unchecked((int)0xFF59);
        ...
        public const int KDU_DCO = unchecked((int)0xFF70);
        public const int KDU_QPD = unchecked((int)0xFF5A);
        public const int KDU_QPC = unchecked((int)0xFF5B);
        public const int KDU_VMS = unchecked((int)0xFF71);
        public const int KDU_RLT = unchecked((int)0xFF95);
        public const int KDU_SEC = unchecked((int)0xFF65);
        public const int KDU_INSEC = unchecked((int)0xFF94);
        public const int KDU_NSI = unchecked((int)0xFF54);
        public const int KDU_EPB = unchecked((int)0xFF66);
        public const int KDU_ESD = unchecked((int)0xFF67);
        public const int KDU_EPC = unchecked((int)0xFF68);
        public const int KDU_RED = unchecked((int)0xFF69);
        public const int KDU_HDT = unchecked((int)0xFF7A);
        ...
        public const int KDU_MEMBROKER_THROW = unchecked((int)1);
        ...
        public const int KDU_SOURCE_CAP_MEMORY_BACKED = unchecked((int)0x0010);
        public const int KDU_SOURCE_CAP_ASYNC_NOTIFICATION = unchecked((int)0x0020);
        public const int KDU_SOURCE_SPAN_EXISTS = unchecked((int)0x0001);
        public const int KDU_SOURCE_IS_COMPLETE = unchecked((int)0x0002);
        public const int KDU_SOURCE_WILL_NOTIFY = unchecked((int)0x0004);
        public const int KDU_MEMBACKED_SOURCE_UNSERVICED = unchecked((int)1);
        public const int KDU_MEMBACKED_SOURCE_PARTIALLY_SERVICED = unchecked((int)2);
        public const int KDU_MEMBACKED_SOURCE_FULLY_SERVICED = unchecked((int)3);
        ...
        public const byte KDU_CPLEX_REC_MORE_SETS = unchecked((byte)1);
        public const int KDU_CS_RESTRICT_COMPONENTS = unchecked((int)1);
        public const int KDU_CS_RESTRICT_LEVELS = unchecked((int)2);
        public const int KDU_CS_RESTRICT_LAYERS = unchecked((int)4);
        public const int KDU_CS_RESTRICT_REGION = unchecked((int)8);
        public const int KDU_CS_RESTRICT_QUALITY = unchecked((int)16);
        public const int KDU_SLOPE_HINT_ESTIMATE = unchecked((int)1);
        public const int KDU_SLOPE_HINT_PREFER_KNOWN_BOUND = unchecked((int)2);
        public const int KDU_SLOPE_HINT_IGNORED_WITH_CPLEX_EST = unchecked((int)4);
        public const int KDU_SLOPE_HINT_DEFAULT = unchecked((int)7);
        ...
        public const long KDU_AUTO_COMMENT_VERSION = unchecked((long)1);
        public const long KDU_AUTO_COMMENT_FLUSH = unchecked((long)2);
        public const int KDU_LOAD_SEQUENTIAL_WANT_TILE = unchecked((int)1);
        public const int KDU_LOAD_SEQUENTIAL_WANT_FLUSH_SET = unchecked((int)2);
        public const int KDU_LOAD_SEQUENTIAL_WANT_PACKET_BYTES = unchecked((int)4);
        ...
        public const int KDU_MAX_FRAGMENTS = unchecked((int)30);
        ...
        public const int KDU_ParamsClass_FIXED = unchecked((int)1);
        public const int KDU_ParamsClass_CODING = unchecked((int)2);
        public const int KDU_ParamsClass_RGN = unchecked((int)4);
        public const int KDU_ParamsClass_POC = unchecked((int)8);
        public const int KDU_ParamsClass_INFO = unchecked((int)16);
        public const string SIZ_params = unchecked((string)"SIZ");
        public const string Sprofile = unchecked((string)"Sprofile");
        public const string Scpf_profile = unchecked((string)"Scpf_profile");
        public const string Sconf_profile = unchecked((string)"Sconf_profile");
        public const string Sbroadcast = unchecked((string)"Sbroadcast");
        public const string Simf = unchecked((string)"Simf");
        public const string Sprf_num = unchecked((string)"Sprf_num");
        public const string Scpf_num = unchecked((string)"Scpf_num");
        public const string Sextensions = unchecked((string)"Sextensions");
        public const string Scap = unchecked((string)"Scap");
        public const string Sncap = unchecked((string)"Sncap");
        public const string SCP2_caps = unchecked((string)"SCP2_caps");
        public const string SCP15_magb = unchecked((string)"SCP15_magb");
        public const string SCP15_limb = unchecked((string)"SCP15_limb");
        public const string SCP15_caps = unchecked((string)"SCP15_caps");
        public const string SCP17_caps = unchecked((string)"SCP17_caps");
        public const string Sallowed = unchecked((string)"Sallowed");
        public const string Srequired = unchecked((string)"Srequired");
        public const string Smodes_allowed = unchecked((string)"Smodes_allowed");
        public const string Smodes_required = unchecked((string)"Smodes_required");
        public const string Slevels_allowed = unchecked((string)"Slevels_allowed");
        ...
        public const string Scbr = unchecked((string)"Scbr");
        ...
        public const int Sprofile_PART1 = unchecked((int)2);
        public const int Sprofile_PART2 = unchecked((int)3);
        public const int Sprofile_OTHER = unchecked((int)16384);
        public const int Sprofile_PART1_UNREC = unchecked((int)4095);
        public const int Sprofile_PART2_UNREC = unchecked((int)32768);
        public const int Sprofile_OTHER_UNREC = unchecked((int)32767);
        ...
        public const int Scap_P2 = unchecked((int)1073741824);
        public const int Scap_P10 = unchecked((int)4194304);
        public const int Scap_P15 = unchecked((int)131072);
        public const int Scap_P17 = unchecked((int)32768);
        public const int Scap_NOTP2 = unchecked((int)-1073741825);
        public const int Scap_PALL = unchecked((int)-1);
        public const int Sallowed_EPH = unchecked((int)1);
        public const int Sallowed_SOP = unchecked((int)2);
        public const int Sallowed_RGN = unchecked((int)4);
        public const int Sallowed_PPM = unchecked((int)8);
        public const int Sallowed_PPT = unchecked((int)16);
        public const int Sallowed_POC = unchecked((int)32);
        public const int Sallowed_HET = unchecked((int)64);
        public const int Sallowed_CHET = unchecked((int)128);
        public const int Sallowed_RHET = unchecked((int)256);
        public const int Sallowed_PHET = unchecked((int)512);
        public const int Sallowed_LYRS = unchecked((int)1024);
        public const int Sallowed_FRAG = unchecked((int)2048);
        public const int Sallowed_ALL = unchecked((int)4095);
        public const int Srequired_EPH = unchecked((int)1);
        public const int Srequired_SOP = unchecked((int)2);
        public const int Srequired_TLM = unchecked((int)4);
        public const int Srequired_PLT = unchecked((int)8);
        public const int Srequired_CPRL = unchecked((int)16);
        public const int Srequired_TPTC = unchecked((int)32);
        public const int Srequired_REV = unchecked((int)64);
        public const int Srequired_IRV = unchecked((int)128);
        public const int Srequired_P256 = unchecked((int)256);
        public const int Srequired_PSMALL = unchecked((int)512);
        public const int Srequired_PgeCB = unchecked((int)1024);
        public const int Srequired_CB5X5 = unchecked((int)2048);
        public const int Srequired_CB7X6 = unchecked((int)4096);
        public const int Srequired_CBto6 = unchecked((int)8192);
        public const int Srequired_CBsq56 = unchecked((int)16384);
        public const int SCP2_caps_EXTENDED_COD = unchecked((int)32768);
        public const int SCP2_caps_ALL = unchecked((int)0x8000);
        public const int SCP15_caps_ORIG = unchecked((int)32768);
        public const int SCP15_caps_MIX = unchecked((int)16384);
        public const int SCP15_caps_SETS = unchecked((int)8192);
        public const int SCP15_caps_RGN = unchecked((int)4096);
        public const int SCP15_caps_HET = unchecked((int)2048);
        public const int SCP15_caps_IRV = unchecked((int)32);
        public const int SCP15_caps_ALL = unchecked((int)0xF820);
        public const int SCP17_caps_ALL = unchecked((int)0);
        ...
        public const string Kkernels = unchecked((string)"Kkernels");
        ...
        public const int Kkernels_I1X1 = unchecked((int)0);
        public const int Kkernels_R1X1 = unchecked((int)1);
        public const int Kkernels_I2X2 = unchecked((int)2);
        public const int Kkernels_R2X2 = unchecked((int)3);
        public const int Kkernels_I5X3 = unchecked((int)4);
        public const int Kextension_CON = unchecked((int)0);
        public const int Kextension_SYM = unchecked((int)1);
        public const string ENC_params = unchecked((string)"ENC");
        public const string Creslengths = unchecked((string)"Creslengths");
        public const string Cagglengths = unchecked((string)"Cagglengths");
        public const string Cplex = unchecked((string)"Cplex");
        public const string Content_type = unchecked((string)"Content_type");
        ...
        public const string Cprog_weights = unchecked((string)"Cprog_weights");
        public const string Ctype = unchecked((string)"Ctype");
        public const string Cxfgain = unchecked((string)"Cxfgain");
        public const string Qstep = unchecked((string)"Qstep");
        public const string Qfix16 = unchecked((string)"Qfix16");
        public const string Qweights = unchecked((string)"Qweights");
        public const string Qfband_weights = unchecked((string)"Qfband_weights");
        public const string Qfactor = unchecked((string)"Qfactor");
        public const string Qfparams = unchecked((string)"Qfparams");
        public const int Cplex_NONE = unchecked((int)0);
        public const int Cplex_FIX = unchecked((int)1);
        public const int Cplex_WFIX = unchecked((int)2);
        public const int Cplex_EST = unchecked((int)3);
        public const int Content_type_PHOTO = unchecked((int)1);
        public const int Content_type_SCREEN = unchecked((int)2);
        public const int Content_type_GRAPHICS = unchecked((int)4);
        public const int Content_type_ENCODED = unchecked((int)8);
        public const int Ctype_N = unchecked((int)0);
        public const int Ctype_Y = unchecked((int)1);
        public const int Ctype_Cb = unchecked((int)2);
        public const int Ctype_Cr = unchecked((int)3);
        public const int Ctype_C = unchecked((int)4);
        public const int Qfix16_FREE = unchecked((int)0);
        public const int Qfix16_LIMIT = unchecked((int)1);
        ...
        public const int Cmodes_HT = unchecked((int)64);
        public const int Cmodes_HTMIX = unchecked((int)128);
        public const int Cmodes_BYPASS_E1 = unchecked((int)256);
        public const int Cmodes_BYPASS_E2 = unchecked((int)512);
        public const int Cmodes_ALL = unchecked((int)1023);
        ...
        public const int KDU_THREAD_QUEUE_PRIORITY_HIGH = unchecked((int)16);
        public const int KDU_THREAD_QUEUE_PRIORITY_URGENT = unchecked((int)32);
        public const int KDU_THREAD_JOB_AUTO_BIND_ONCE = unchecked((int)1);
        public const int KDU_THREAD_JOB_REBIND_0 = unchecked((int)2);
        public const int KDU_FOREIGN_SIGNAL_EXPECTED = unchecked((int)1);
        public const int KDU_FOREIGN_SIGNAL_EXCEPTION = unchecked((int)2);
        ...
        public const int KDU_TIFF_ExtraSamples_UNASSOCIATED_ALPHA = unchecked((int)2);
        ...
        public const long KDU_SIMPLE_VIDEO_CBR = unchecked((long)4);
        public const long jp2_brand = unchecked((long)0x6a703220);
        public const long jph_brand = unchecked((long)0x6a706820);
        public const long jpx_brand = unchecked((long)0x6a707820);
        public const long jpx_baseline_brand = unchecked((long)0x6a707862);
        public const long jpx_ht_baseline_brand = unchecked((long)0x6a687862);
        public const long mj2_brand = unchecked((long)0x6d6a7032);
        ...
        public const int JP2_MCT_MULTI_STAGE = unchecked((int)1);
        public const int JP2_MCT_MULTI_BLOCK = unchecked((int)2);
        public const int JP2_MCT_DEP = unchecked((int)4);
        public const int JP2_MCT_DWT = unchecked((int)8);
        public const int JP2_MCT_REV_MATRIX = unchecked((int)16);
        public const int JP2_EMPTY_SPACE = unchecked((int)-1);
        ...
        public const int JPX_SF_HTJ2K = unchecked((int)86);
        ...
        public const int JP2_HEADER_BOX_FOR_JPH = unchecked((int)1);
